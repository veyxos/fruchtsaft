...
ready(function(){
  ...
  xmlhttp.open("GET", "/assets/js/anni.json", true);
  xmlhttp.onreadystatechange = function() {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
      ...
      document.getElementById("link__tweet").href = "https://twitter.com/intent/tweet?text=" + encodeURI(quotes["quote"][q]["q"].replace(/<br>/g,"\n").replace(/<strong>/g,"").replace(/<\/strong>/g,"")) + "&hashtags=fruchtsaft,quote&url=" + encodeURI("https://fruchtsaft.veyxos.de/anni/?c=" + q) + "&via=TheEmerl&related=TheEmerl%3ADer%20Typ%20um%20den%27s%20hier%20geht%2CVeyxos%3AEr%20hat%20das%20alles%20hier%20verbrochen!";
      document.getElementById("link__copy").setAttribute("data-clipboard-text","http://fruchtsaft.veyxos.de/anni/?c=" + q);
