$(document).ready(function(){
  ...
  setTimeout(function(){
    ...
    emerl__share_mail.href = "mailto:user@example.com";
    ...
    anni__share_mail.href = "mailto:user@example.com";
  ...
  function newQuote(type){
    if (type === "emerl") {
      ...
      var emerl__url = "http://fruchtsaft.veyxos.de/?a=" + quotes["fruchtsaft"][e]["codename"];
      $("#emerl_quote").html(quotes["fruchtsaft"][e]["quote"]);
      $("#emerl_author").html(quotes["authors"][quotes["fruchtsaft"][e]["author"]]);
      $("#emerl_date").html(quotes["fruchtsaft"][e]["date"]);
      emerl__last_quote = e;
